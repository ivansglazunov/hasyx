...
import { validateTelegramInitData } from '../telegram/telegram-miniapp-server';
import Debug from '../debug';
import { withCors } from '../cors';

const debug = Debug('api:auth:verify-telegram-webapp');

export async function handleVerifyTelegramWebApp(request: NextRequest) {
...
export async function handleVerifyTelegramWebAppOptions(request: NextRequest) {
