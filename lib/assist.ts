...
import { configureOpenRouter } from './ai/providers/assist-openrouter';
...
import { configureDns } from './cloudflare/assist-dns';
import Debug from './debug';
import { configureStorage } from './files/assist-storage';
import { Generator } from './generator';
import { configureGitHubToken } from './github/assist-github';
import { checkGitHubAuth, setupRepository } from './github/assist-github-auth';
import { configureGitHubWebhooks } from './github/assist-github-webhooks';
import { configureHasura } from './hasura/assist-hasura';
import { initializeHasyx } from './hasyx/assist-hasyx';
import { Hasyx } from './hasyx/hasyx';
import { configureFirebaseNotifications } from './notify/assist-firebase';
import { calibrateTelegramBot, configureTelegramBot } from './telegram/assist-telegram';
import { setupAuthSecrets } from './users/assist-auth-secrets';
import { configureOAuth } from './users/assist-oauth';
import { configureProjectUser } from './users/assist-project-user';
import { configureResend } from './users/assist-resend';
